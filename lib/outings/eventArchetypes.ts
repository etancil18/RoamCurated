...
> = {
  social_sports: {
    ...
    beforeSemanticRoles: ['pre_game_meal', 'group_drinks'],
    afterSemanticRoles: ['post_game_drinks', 'casual_food'],
    preferredBeforeVenueTypes: ['sports bar', 'brewery', 'bar', 'restaurant', 'lunch', 'dinner'],
    preferredAfterVenueTypes: ['sports bar', 'brewery', 'bar', 'restaurant', 'late night'],
    discouragedVenueTypes: ['spa', 'library', 'showroom'],
    preferredVibes: ['lively', 'casual', 'group-friendly'],
