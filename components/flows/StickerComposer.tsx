...
export default function StickerComposer({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-5xl overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-950 shadow-2xl"
      ...
      >
        <div className="flex flex-col gap-3 border-b border-neutral-800 px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-xs text-neutral-400">
              Add a photo background and position your Roam Passport Sticker.
            </p>
          </div>
        ...
        <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div className="flex justify-center overflow-auto rounded-2xl border border-neutral-800 bg-black p-4">
            <div
              ref={exportRef}
              className="relative h-[640px] w-[360px] overflow-hidden rounded-[2rem] bg-gradient-to-br from-neutral-950 via-slate-950 to-black"
            >
              {backgroundUrl ? (
                <img
                  src={backgroundUrl}
          ...
          <div className="space-y-5 rounded-2xl border border-neutral-800 bg-black/40 p-4">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-3 text-xs leading-5 text-neutral-400">
              Tip: choose a photo with darker open space, then position the
              sticker where it feels like a Passport stamp or route overlay.
            </div>
          </div>
        </div>
      </div>
